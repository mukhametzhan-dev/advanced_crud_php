...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['billingID'])) {
    $billingID = $_POST['billingID'];

    $sql = "DELETE FROM P2Billing WHERE BillingID = $billingID AND login = '$usr'";
    ...
    <div class="container">
        ...
        <form action="delete_billing.php" method="post">
            <div class="input-group">
                ...
                <input type="number" id="billingID" name="billingID" required>
            </div>
